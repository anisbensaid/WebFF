...
WEBSITE_SHORT_TITLE = "WebFF"
CUSTOM_DATA = "WebFF Data"
CUSTOM_NAME = os.environ["SERVER_NAME"] if "SERVER_NAME" in os.environ else "Curator"
CUSTOM_TITLE = "Force-Field (FF) repository"
CUSTOM_SUBTITLE = "Part of the Materials Genome Initiative (MGI) for organic and related soft materials"
